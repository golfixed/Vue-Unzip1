  ...
  <div class="header-div" style="position: fixed; z-index: 999;">
      <div class="container header-cont">
        <div class="row header-webtitle-div d-flex align-items-center">
          ...
          <div class="row navbar-div d-flex justify-content-center nav-show2">
              <div class="container d-flex align-items-center justify-content-center">
                <nav :class="[{'show': hamburger}, 'nav-display']">
                  <ul id="navbar-nav">
                    <li class="active">
                      <a href="#" v-scroll-to="'#regis'"><mdb-icon far icon="edit" style="margin-right: 10px;" />{{ $t("message.navbar.regis") }}</a>
                    </li>
                    <li>
                      <a href="#" v-scroll-to="'#timetable'"><mdb-icon icon="table" style="margin-right: 10px;" />{{ $t("message.navbar.col1") }}</a>
                    </li>
                    <li>
                      <a href="#" v-scroll-to="'#location'"><mdb-icon icon="map-marker-alt" style="margin-right: 10px;" />{{ $t("message.navbar.col2") }}</a>
                    </li>
                    <li>
                      <a href="#" v-scroll-to="'#sponsor'"><mdb-icon icon="users" style="margin-right: 10px;" />{{ $t("message.navbar.col3") }}</a>
                    </li>
                    <li>
                      <a href="#" v-scroll-to="'#faq'"><mdb-icon icon="question-circle" style="margin-right: 10px;" />{{ $t("message.navbar.col4") }}</a>
                    </li>
                  </ul>
                </nav>
              </div>
...
@media (max-width: 768px){
    ...
    .header-div {
      background-color: rgba(27, 27, 56, 0.9) !important;
    }
}
